...
class InMemoryDocumentRepository(DocumentRepository):
    ...
    def save(self, document: Document) -> None:
        ...
        with self._lock:
            ...
            logger.debug(
                "Document saved", doc_id=document.id, lib_id=document.library_id
            )
    ...
    def get(self, document_id: DocumentID) -> Optional[Document]:
        ...
        with self._lock:
            ...
            logger.debug(
                "Document retrieved", doc_id=document_id, found=document is not None
            )
            return document
    ...
    def get_by_library(self, library_id: LibraryID) -> List[Document]:
        ...
        with self._lock:
            ...
            logger.debug(
                "Documents retrieved from library",
                lib_id=library_id,
                count=len(documents),
            )
            return documents
    ...
    def delete(self, document_id: DocumentID) -> None:
        ...
        with self._lock:
            ...
            logger.debug(
                "Document deleted", doc_id=document_id, lib_id=document.library_id
            )
...
class InMemoryLibraryRepository(LibraryRepository):
    ...
    def get(self, library_id: LibraryID) -> Optional[Library]:
        ...
        with self._lock:
            ...
            logger.debug(
                "Library retrieved", lib_id=library_id, found=library is not None
            )
            return library
